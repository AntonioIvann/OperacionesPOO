class Multiplicacion {// Declaración de la clase Multiplicaion
    int num1, num2;// Declaración dos variables llamadas num1 y num2
    Multiplicacion() {// Creamos un metodo constructor llamado multiplicacion
    }
