...
public class MainMo {// Nombre de la clase
    public static void main(String[] args) {// Metodo main
        ...
        do {// Bucle do-while es para que el menu se repita hasta que el usuario decida salir
            // Mostramos el menu
            System.out.println("\n--- Menú ---");
            System.out.println("1. Realizar un modulo");
            ...
            switch (pc) {// Usamos un switch para las opciones
                case 1:
                    ...
                    System.out.println("El resultado del modulo es: " + (s1.getNum1() % s1.getNum2()));//// Imprime el resultado del modelo
                    break;// Termina el primer case
                case 2:
                    System.out.println("Saliendo del programa...");// Se imprime un mensje que esta saliendo del modulo
