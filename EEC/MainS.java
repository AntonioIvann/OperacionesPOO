...
public class MainS {// Nombre de la clase
        ...
        do {// Bucle do-while es para que el menu se repita hasta que el usuario decida salir
            ...
            switch (pc) {// Usamos un switch para las opciones
                case 1:
                    ...
                    System.out.println("El resultado de la suma es: " + (s1.getNum1() + s1.getNum2()));//// Imprime el resultado de la suma
                    break;// Termina el primer case
                case 2:
                    System.out.println("Saliendo del programa...");// Se imprime un mensje que esta saliendo de la suma
